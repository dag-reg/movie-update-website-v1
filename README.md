...
<html b:css='false' b:defaultwidgetversion='2' b:layoutsVersion='3' b:responsive='true' b:templateVersion='1.3.0' expr:class='data:blog.languageDirection' expr:dir='data:blog.languageDirection' expr:lang='data:blog.localeUnderscoreDelimited' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
  <head>
    <meta content='A1AFQ8Tb_ejEtYTPC5mlMwxKTnHd21Cwf8glqIb54O0' name='google-site-verification'/>
...
<!-- Variable definitions -->
		<Variable name="keycolor" description="Main Color" type="color" default="$(main.color)" value="#5401d8"/>		
...
.FreeDemos-wera .widget>.widget-title{display:flex;justify-content:space-between;align-items:center;position:relative;margin:0;z-index:11;float:none;background:$(widget.title.color);width:100%;height:32px;box-sizing:border-box;margin:0;}
.FreeDemos-wera .widget>.widget-title h3{position:relative;float:left;font-family:var(--title-font);height:32px;font-size:13px;background:$(widget.background);color:$(widget.title.color);text-transform:uppercase;font-weight:600;line-height:32px;padding:0 15px;margin:0 0 0 10px;}
...
.FreeDemos-werg{position:relative;margin:5px auto;background:$(widget.background);overflow:hidden;}
.FreeDemos-werg .widget{display:block;height:25px;padding:5px 0;margin:0}
.FreeDemos-werg .widget>.widget-title{display:block;position:relative;float:left;color:$(widget.title.color);font-size:11px;text-transform:uppercase;height:25px;line-height:25px;padding:0 10px;margin:0 10px 0 5px;border-right:1px solid $(widget.title.color)}
...
.FreeDemos-werx .entry-title a{position:relative;display:block;overflow:hidden;font-size:16px;color:$(widget.title.color);}
...
.mydivs-bt>a{display:flex;width:20px;height:20px;line-height:20px;font-size:12px;text-align:center;margin:0 2px;padding:5px;cursor:pointer;color:#fff;background:$(breaking.bt)}
...
.sidebar .widget-title h3,.FreeDemos-werd .widget>.widget-title h3,.related-post .widget-title h3{position:relative;float:left;font-family:var(--title-font);height:32px;font-size:13px;color:$(widget.title.color);background:$(widget.background);text-transform:uppercase;font-weight:600;line-height:32px;padding:0 15px;margin:0;}
...
.comment-home-bubble{color:#fff;background:$(widget.background);display:inline-block;min-width:8px;padding:2px 8px;position:relative}
.comment-home-bubble:before{position:absolute;bottom:-3px;left:0;content:'';width:0;height:0;border-style:solid;border-width:3px 3px 0 0;border-color:$(widget.background) transparent transparent transparent}
...
.label-news,.label-news-flex{float:left;top:20px;left:10px;height:10px;z-index:5;background-color:$(main.tag);color:$(widget.title.color);font-size:10px;line-height:10px;font-weight:500;white-space:nowrap;width:auto;overflow:hidden;padding:5px 7px}
...
.NewsFooter .social-footer li a{display:block;width:34px;height:34px;font-size:22px;margin:5px 0;color:$(footer.post.color);text-align:center;line-height:34px}
.NewsFooter .social-footer li a:hover{opacity:0.8}
.post-snippet{position:relative;overflow:hidden;font-size:13px;line-height:1.6em;font-weight:400;margin:7px 0 0}
a.read-more{display:none;color:$(main.color);font-size:13px;font-weight:500;text-transform:uppercase;margin:15px 0 0;transition:color .30s ease}
...
.label-container a{color:$(widget.title.color);margin:0 5px 5px;transition:all .30s ease}
...
.share-buttons li.share-icon span{position:relative;background-color:#fff;font-size:14px;color:$(title.color);cursor:auto;margin:0 5px 0 0}
...
.FreeDemos-werr li a{color:$(title.color);line-height:1.4em;display:block;overflow:hidden;transition:color .40s}
.FreeDemos-werr li:hover a{color:$(main.hover)}
...
#blog-pager-ok .load-more{display:inline-block;height:34px;background-color:$(widget.background);font-size:14px;color:$(widget.title.color);font-weight:400;line-height:34px;box-sizing:border-box;padding:0 30px;margin:0;border:1px solid rgba(0,0,0,.1);border-bottom-width:2px;border-radius:2px}
#blog-pager-ok .load-more:hover{background-color:$(main.hover)}
#blog-pager{float:left;width:100%;overflow:hidden;clear:both;margin:10px 0 30px}
.blog-pager a,.blog-pager span{float:left;display:block;min-width:32px;height:32px;background-color:#f5f5f5;color:$(title.color);font-size:13px;font-weight:700;line-height:32px;text-align:center;box-sizing:border-box;padding:0 10px;margin:0 5px 0 0;border-radius:3px;transition:all .17s ease}
...
.title-wrap{position:relative;float:none;width:100%;height:32px;box-sizing:border-box;margin:0 0 20px;border-bottom:2px solid $(widget.background)}
.title-wrap h3{position:relative;float:left;font-family:var(--title-font);height:32px;background-color:$(widget.background);font-size:13px;color:$(widget.title.color);text-transform:uppercase;font-weight:600;line-height:32px;padding:0 15px;margin:0}
.title-wrap h3:after{position:absolute;content:'';height:0;width:0;bottom:0;right:-16px;border:0;border-top:32px solid transparent;border-left:16px solid $(widget.background);margin:0}
...
.comments .comments-content .comment-header a{color:$(title.color);transition:color .40s}
...
.comments .comment .comment-actions a{margin-right:5px;padding:2px 5px;color:$(title.color);font-weight:400;background-color:#f2f2f2;font-size:10px;transition:all .30s ease}
...
.list-label li a{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:$(widget.background);font-size:12px;font-weight:600;text-transform:capitalize;transition:all .30s ease}
.list-label li a:before{content:"\f101";float:left;color:$(widget.background);font-weight:900;font-family:'Font Awesome 5 Free';font-size:12px;line-height:12px;margin:5px 4px 0 0;transition:color .5s}
...
.cloud-label li a:hover{background-color:$(main.hover);color:$(widget.title.color);transition:all .20s ease;}
...
#ArchiveList .flat li>a{display:block;color:$(title.color);transition:color .40s}
#ArchiveList .flat li>a:hover{color:$(main.hover)}
#ArchiveList .flat li>a:before{content:"\f054";font-family:'Font Awesome 5 Free';float:left;color:#161619;font-size:7px;font-weight:400;margin:5px 2px 0 0;display:inline-block;transition:color .30s}
#ArchiveList .flat li>a>span{position:relative;background-color:$(main.color);color:#fff;float:right;width:16px;height:16px;font-size:10px;font-weight:400;text-align:center;line-height:15px}
...
.PopularPosts .post:hover .entry-title a{color:$(main.hover)}
.PopularPosts .post-date:before{font-size:10px}
.FeaturedPost .post-filter-link{display:block;position:relative;width:100%;height:250px;overflow:hidden;margin:0 0 10px}
.FeaturedPost .entry-title{font-size:14px;font-weight:600;overflow:hidden;line-height:1.2em;margin:0}
.FeaturedPost .entry-title a{color:$(title.color);display:block;transition:color .30s ease}
.FeaturedPost .entry-title a:hover{color:$(main.hover)}
...
.contact-form-button-submit{float:left;width:100%;height:30px;background-color:$(main.color);font-size:13px;color:#fff;line-height:30px;cursor:pointer;box-sizing:border-box;padding:0 10px;margin:10px 0;border:0;border-radius:2px;transition:background .30s ease}
.contact-form-button-submit:hover{background-color:$(main.hover)}
...
.BlogSearch .search-action{float:right;width:25%;height:40px;font-family:inherit;font-size:13px;line-height:40px;cursor:pointer;box-sizing:border-box;background-color:$(widget.background);color:#fff;padding:0 5px;border:0;border-radius:0 2px 2px 0;transition:background .30s ease}
.BlogSearch .search-action:hover{background-color:$(main.hover)}
.Profile .profile-img{float:left;width:80px;height:80px;margin:0 15px 0 0;transition:all .30s ease}
.Profile .profile-info >.profile-link{color:$(title.color);font-size:11px;margin:5px 0 0}
.Profile .profile-info >.profile-link:hover{color:$(main.hover)}
...
.widget-control .LinkList ul li a:hover,.widget-control .PageList ul li a:hover{color:$(main.hover);transition:all .5s ease;border-radius:4px}
.widget-control .LinkList ul li:first-child,.widget-control .LinkList ul li:nth-child(2),.widget-control .PageList ul li:first-child,.widget-control .PageList ul li:nth-child(2){padding:0}
/*-- Footer Section Codes --*/
#footer-wrapper{background-color:$(footer.background.color)}
...
.footer .widget>.widget-title>h3{position:relative;font-family:var(--title-font);color:$(footer.widget.title);font-size:14px;font-weight:700;line-height:14px;border-bottom:1px solid #767676;text-transform:uppercase;padding:0 0 5px;margin:15px 0 25px}
.footer .custom-widget .entry-title a,.footer .PopularPosts .entry-title a,.footer .FeaturedPost .entry-title a,.footer .PageList ul li a,.footer .Profile .profile-info>.profile-link{color:$(footer.post.color)}
.footer .LinkList ul li a{color:#000}
.footer .custom-widget .entry-title a:hover,.footer .PopularPosts .entry-title a:hover,.footer .FeaturedPost .entry-title a:hover,.footer .LinkList ul li a:hover,.footer .PageList ul li a:hover,.footer .Profile .profile-info>.profile-link:hover{color:$(main.hover)}
.footer .post-snip{color:#aaa}
.footer .FollowByEmail .widget-content>h3{color:$(footer.post.color)}
.footer .FollowByEmail .widget-content{background-color:rgba(255,255,255,0.05);border-color:rgba(255,255,255,0.05)}
.footer .FollowByEmail .before-text,#footer-wrapper .footer .Text{color:#aaa}
.footer .FollowByEmail .follow-by-email-inner .follow-by-email-submit:hover{background:$(main.hover)}
.footer .FollowByEmail .follow-by-email-inner .follow-by-email-address{background-color:rgba(255,255,255,0.05);color:$(footer.post.color);border-color:rgba(255,255,255,0.05)}
.footer #ArchiveList .flat li>a{color:$(footer.post.color)}
.footer .list-label li,.footer .BlogArchive #ArchiveList ul.flat li{border-color:rgba(255,255,255,0.05)}
.footer .list-label li:first-child{padding-top:0}
.footer .list-label li a,.footer .list-label li a:before,.footer #ArchiveList .flat li>a,.footer #ArchiveList .flat li>a:before{color:$(footer.post.color)}
.footer .list-label li>a:hover,.footer #ArchiveList .flat li>a:hover{color:$(main.hover)}
.footer .list-label .label-count,.footer #ArchiveList .flat li>a>span{background-color:rgba(255,255,255,0.05);color:$(footer.post.color)}
.footer .cloud-label li a{border-color:rgba(255,255,255,0.05);color:$(footer.post.color)}
.footer .cloud-label li a:hover{background-color:$(main.color);color:#fff}
.footer .BlogSearch .search-input{background-color:rgba(255,255,255,0.05);color:$(footer.post.color);border-color:rgba(255,255,255,0.05)}
.footer .contact-form-name,.footer .contact-form-email,.footer .contact-form-email-message{background-color:rgba(255,255,255,0.05);color:$(footer.post.color);border-color:rgba(255,255,255,0.05)}
.footer .BlogSearch .search-action:hover,.footer .FollowByEmail .follow-by-email-inner .follow-by-email-submit:hover,.footer .contact-form-button-submit:hover{background-color:#3c3c3c}
.footer .contact-form-button-submit{background:$(main.hover)}
/*-- Back to Top --*/
.backTop{display:none;z-index:1010;width:32px;height:32px;position:fixed;bottom:25px;right:25px;cursor:pointer;overflow:hidden;font-size:13px;color:#fff;text-align:center;line-height:32px}
.backTop:before{content:'';position:absolute;top:0;left:0;right:0;bottom:0;background-color:$(main.hover);opacity:.5;transition:opacity .30s ease}
.backTop:after{content:'\f077';position:relative;font-family:'Font Awesome 5 Free';font-weight:900;opacity:.8;transition:opacity .30s ease}
.backTop:hover:before,.backTop:hover:after,.MenuNews-open .backTop:after,.MenuNews-open .backTop:before{opacity:1}
/*-- Custom 404 Error Page --*/
.error404 #feed-view{width:100%!important;margin:0!important}
.error404 #sidebar-container{display:none}
.errorPage{color:$(title.color);text-align:center;padding:80px 0 100px}
.errorPage h3{font-size:160px;line-height:1;margin:0 0 30px}
.errorPage h4{font-size:25px;margin:0 0 20px}
.errorPage p{margin:0 0 10px}
.errorPage a{display:block;color:$(main.color);padding:10px 0 0}
...
.FreeDemos-werg .breaking-content{background:$(breaking.content);margin:0 3px;}
...
.FreeDemos-werw ul li a,span#Date:before{color:$(submenu.color)}
span#Date{display:block;border:none;background:transparent;}
#feed-view,#sidebar-container{width:100%;padding:0}
.search-button{background-color:$(main.tag)}
...
#MenuNews-list>li>a,.FreeDemos-weri>ul>li>ul>li a,.FreeDemos-weri ul li a{color:$(submenu.color)}
...
<![CDATA[
/*------Layout (No Edit)----------*/
body#layout #outer-wrapper,body#layout .outer-container{width:auto;padding:0}
body#layout{width:98%;position:relative;background:#dbdbdb;padding:95px 5px 0;margin:1px;border:1px solid #def2ff}
body#layout:before{content:"News Blogger V.1.0.0";font-family:'Font Awesome 5 Free';position:absolute;top:20px;right:20px;z-index:1;padding:10px 20px;font-size:18px;font-weight:bold;color:#fff;background:#006671;border:1px solid #213243!important}
body#layout div.section{display:block;background-color:#def2ff!important;margin:0 5px 10px!important;padding:16px 16px 18px!important;border-color:#009bde}
body#layout .widget-content{width:auto;max-width:none;max-height:none;margin:0;border:1px solid #3363ff;border-left:0}
...
body#layout div#top-menu,body#layout div#top-social{width:50%;display:block;}
body#layout .admin-area,body#layout #main-menu .widget{display:block!important}
body#layout div.admin-section{background-color:#FF4100!important;overflow:hidden!important;border-color:#bcbcbc}
body#layout .admin-area .widget-wrap1{margin:0 10px;}
body#layout .admin-section .widget{float:left;width:50% !important;}
body#layout #custom-ads-placeholder{display:block!important;display:flex!important}
body#layout #custom-ads-placeholder .section{width:49%}
body#layout .row{display:flex}
body#layout .show-FreeDemos-were,body#layout .search-toggle{display:none}
body#layout .FreeDemos-wery1 > .container{display:flex}
body#layout .MenuNewsLogo-wrap{width:40%}
body#layout .clear-ads{width:60%}
body#layout .section > h4:after{font-size:12px;font-size:12px;font-weight:400;}
body#layout .widget-flex{display:flex;margin:auto;}
body#layout .widget-flex .section{width:100%;}
...
body#layout #MenuNewsLogo > h4:after{content:' - Recommended Height 80px logo'}
body#layout #MenuNewsAD > h4:after{content:' - Use 768px × 90px size ads recommended'}
body#layout #top-news-menu > h4:after{content:' - Top Trending Tags edit from here'}
body#layout #FreeDemos-wero > h4:after{content:' - Main Menu and Submenu Links here'}
body#layout #FreeDemos-werg > h4:after{content:' - Breaking Ticker News section'}
...
body#layout #top-NewsPro-main-widget-3 > h4:after{content:' - Bottom Homepage Full View Posts'}
...
body#layout #top-NewsPro-main-widget-1 > h4:after{content:' - Botttom Main Wrapper Feature Posts'}
body#layout #main-ads2 > h4:after{content:' - Bottom Footer Ads Section (responsive)'}
body#layout #footer-sec2 > h4:after{content:' - Left side Footer Widgets'}
body#layout #footer-widget > h4:after{content:' - Center side Footer Widgets'}
body#layout #footer-sec3 > h4:after{content:' - Right side Footer Widgets'}
body#layout #NewsFooter > h4:after{content:' - Footer Pages and social media icon links'}
body#layout #footer-NBogger-menu > h4:after{content:' - Footer Pages Links'}
body#layout #footer-copyright > h4:after{content:' - Footer Copyright Link'}
body#layout #sidebar1 > h4:after{content:' - Sidebar top Section'}
body#layout #social-widget > h4:after{content:' - Sidebar Social Media icon links'}
...
body#layout #NewsFooter{overflow:hidden!important}
body#layout #NewsFooter .widget{float:left;width:49%;margin-right:2%}
body#layout #NewsFooter .LinkList{margin-right:0}
body#layout #footer-container{display:flex}
body#layout #footer-copyright,body#layout #footer-NBogger-menu{width:50%}
...
<b:defaultmarkups>
  ...
  <b:if cond='data:widget.sectionId not in [&quot;ft-post&quot;,&quot;MenuNewsAD&quot;]'>
...
<b:case value='relatedPostsText'/><b:if cond='data:blog.locale.language == &quot;en&quot;'><data:messages.youMayLikeThesePosts/></b:if>
<b:case value='loadMorePosts'/><b:if cond='data:blog.locale.language == &quot;en&quot;'>Load More<b:else/><data:messages.loadMorePosts/></b:if>
<b:case value='followByEmailText'/><b:if cond='data:blog.locale.language == &quot;en&quot;'><data:messages.getEmailNotifications/></b:if>
     </b:switch>
    </b:includable>
      ...
      <div class='post'>
        <div class='post-content'>
          <a class='post-filter-link' expr:href='data:post.url'>
            ...
            <span class='label-news'><data:post.labels.last.name/></span>
          </a>
          <div class='FreeDemos-werj-box'>
...
<!-- Theme Options -->
  <div class='admin-area' style='display:none'>
    <b:section class='admin-section' id='admin' maxwidgets='1' name='Theme Options (Admin Panel)' showaddelement='no'>
      <b:widget id='TextList15' locked='true' title='Facebook SDK (Plugin)' type='TextList' visible='true'>
        <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
    </b:includable>
      ...
      <b:widget id='LinkList25' locked='true' title='Variables / Comments' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
      ...
      <b:widget id='LinkList27' locked='true' title='Lazy Scrolls / More Text' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
              ...
              <div id='top-menu'>
                <b:section class='menu-top' id='menu-top' maxwidgets='1' name='Top Menu' showaddelement='no'>
                  <b:widget id='LinkList3' locked='true' title='Top menu' type='LinkList' version='2' visible='true'>
                    <b:widget-settings>
                      <b:widget-setting name='link-3'>https://dagreg-company.blogspot.com/</b:widget-setting>
                      <b:widget-setting name='sorting'>NONE</b:widget-setting>
                      <b:widget-setting name='text-1'>Contact us</b:widget-setting>
                      <b:widget-setting name='link-1'>https://dagreg-company.blogspot.com/p/contact-us.html</b:widget-setting>
                      <b:widget-setting name='text-0'>About Us</b:widget-setting>
                      <b:widget-setting name='link-2'>https://cingster.blogspot.com/p/privacy-policy.html</b:widget-setting>
                      <b:widget-setting name='text-3'>Parent company</b:widget-setting>
                      <b:widget-setting name='link-0'>https://cingster.blogspot.com/p/about-us.html</b:widget-setting>
              ...
              <div id='top-social'>
                <b:section class='social-sec' id='social-sec' maxwidgets='1' name='Top Social icons' showaddelement='no'>
                  <b:widget id='LinkList4' locked='true' title='top social' type='LinkList' version='2' visible='true'>
                    <b:widget-settings>
                      <b:widget-setting name='link-5'>https://github.com/dag-reg/</b:widget-setting>
                      <b:widget-setting name='link-3'>https://twitter.com/</b:widget-setting>
                      <b:widget-setting name='link-4'>https://www.instagram.com/</b:widget-setting>
                      ...
                      <b:widget-setting name='text-5'>github</b:widget-setting>
 ...
 <div class='FreeDemos-wery1'>
  <div class='container'>
   <div class='MenuNewsLogo-wrap'>
            <b:section class='MenuNewsLogo' id='MenuNewsLogo' maxwidgets='1' name='Main Logo' showaddelement='no'>
              <b:widget id='Header1' locked='true' title='CINGSTER (Header)' type='Header' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEh_79uT1IyoCa4fy8TgH0Y1F3WFk0pAp-2RSLEhCf0s_zBVKG5J8vnYehxTWPmYOAbt579Kon6NX8o_D36KWJNWL1VVEdPNiey16KLSyTP2PxxDiqWwJ6ZZASWjrxRnatM2EX_M5iHJivdHJLrhs5yJj1byriaJVQe8c_hrHsB6r4ovK8db9DkZM1snEA=s294</b:widget-setting>
                ...
                <b:includable id='image'>
                  <a class='MenuNewsLogo-img' expr:href='data:blog.homepageUrl'>
                    <img expr:alt='data:blog.title.escaped' expr:data-height='data:height' expr:data-width='data:width' expr:src='data:image'/>
                    <b:if cond='data:view.isHomepage'><b:if cond='data:widget.sectionId == &quot;MenuNewsLogo&quot;'><h1 id='title-header'><data:title/></h1></b:if></b:if>
                  </a>
                </b:includable>
      ...
      <b:if cond='data:view.search.label'><h2 class='blog-title'><b:tag expr:href='data:blog.homepageUrl' name='a'><data:view.search.label/></b:tag></h2></b:if> 
           ...
           <div class='clear-ads'>
            <b:section class='MenuNewsad' id='MenuNewsAD' maxwidgets='1' name='Header Ad (768 x 90)' showaddelement='yes'>
              <b:widget id='HTML2' locked='false' title='Hot Widget' type='HTML' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;57a2d8f6c60692359d0d513400aa3933&#39;,
		&#39;format&#39; : &#39;iframe&#39;,
		&#39;height&#39; : 90,
		&#39;width&#39; : 728,
		&#39;params&#39; : {}
	};
	document.write(&#39;&lt;scr&#39; + &#39;ipt type=&quot;text/javascript&quot; src=&quot;http&#39; + (location.protocol === &#39;https:&#39; ? &#39;s&#39; : &#39;&#39;) + &#39;://www.profitabledisplaynetwork.com/57a2d8f6c60692359d0d513400aa3933/invoke.js&quot;&gt;&lt;/scr&#39; + &#39;ipt&gt;&#39;);
&lt;/script&gt;</b:widget-setting>
         ...
         <div class='widget-content'>
           ...
           <div class='clearfix'/>
         <b:section class='top-news-menu' id='top-news-menu' maxwidgets='1' name='Top Tags Menu' showaddelement='yes'>
           <b:widget id='LinkList1' locked='true' title='# Top Tags' type='LinkList' version='2' visible='true'>
             <b:widget-settings>
               <b:widget-setting name='link-3'>/</b:widget-setting>
               <b:widget-setting name='sorting'>NONE</b:widget-setting>
               <b:widget-setting name='text-1'><![CDATA[Movie Trailers & music ]]></b:widget-setting>
               <b:widget-setting name='link-1'>https://cingster.blogspot.com/search/label/Movie%20Trailers%20%26%20music</b:widget-setting>
               <b:widget-setting name='text-0'>Movie updates</b:widget-setting>
               <b:widget-setting name='link-2'>/</b:widget-setting>
               <b:widget-setting name='text-3'>Short film</b:widget-setting>
               <b:widget-setting name='link-0'>https://cingster.blogspot.com/search/label/Movie%20updates</b:widget-setting>
            ...
            <h3 class='title'><data:title/></h3>
                  ...
                  <b:loop values='data:links' var='link'>
                    <div class='feature-buttons'><a expr:href='data:link.target'><data:link.name/></a></div>
                  </b:loop>
              </div>
            </b:includable>
           </b:widget>
    ...
    <div class='FreeDemos-wery-wrap'>
      <div class='FreeDemos-wery'>
        <div class='container outer-container'>
          <a class='show-FreeDemos-were' href='javascript:;'/>
           <nav class='main-menu-wrap' itemscope='itemscope' itemtype='https://schema.org/SiteNavigationElement' role='navigation'>
           <div class='menu' id='menu'>
            <b:section class='FreeDemos-wero' id='FreeDemos-wero' maxwidgets='1' name='Main Menu' showaddelement='no'>
              <b:widget id='LinkList56' locked='true' title='Main Menu' type='LinkList' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='link-5'>https://cingster.blogspot.com/p/privacy-policy.html</b:widget-setting>
                  <b:widget-setting name='link-3'>megamenu/recent</b:widget-setting>
                  <b:widget-setting name='link-4'>megamenu/2recent</b:widget-setting>
                  <b:widget-setting name='text-1'>_Contact us</b:widget-setting>
                  <b:widget-setting name='text-0'>Home</b:widget-setting>
                  <b:widget-setting name='text-3'>Features</b:widget-setting>
                  ...
                  <b:widget-setting name='text-4'>Mega Menu</b:widget-setting>
                  <b:widget-setting name='sorting'>NONE</b:widget-setting>
                  <b:widget-setting name='link-1'>https://cingster.blogspot.com/p/contact-us.html</b:widget-setting>
                  <b:widget-setting name='link-2'>megamenu/recent</b:widget-setting>
                  <b:widget-setting name='link-0'>https://cingster.blogspot.com/</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
                  <b:include name='content'/>
                </b:includable>
 ...
 <div class='ticker'>
<div class='container'>
    <b:section class='FreeDemos-werg' id='FreeDemos-werg' maxwidgets='11' name='Breaking Ticker' showaddelement='no'>
      <b:widget id='HTML6' locked='true' title='Breaking Ticker' type='HTML' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='content'>8/trending/recent</b:widget-setting>
        </b:widget-settings>
        <b:includable id='main'>
  <b:include name='widget-title'/>
...
&lt;/script&gt;</b:widget-setting>
  ...
  <b:section class='FreeDemos-wera flex' id='hot-posts' maxwidgets='1' name='Hot Posts' showaddelement='Yes'>
    <b:widget id='PopularPosts3' locked='false' title='Hotest News' type='PopularPosts' visible='true'>
      <b:widget-settings>
      ...
      <b:section class='FreeDemos-wers flex' id='ft-post' maxwidgets='1' name='Top Feature Section' showaddelement='yes'>
        <b:widget id='PopularPosts4' locked='false' title='Featured Section' type='PopularPosts' visible='true'>
          <b:widget-settings>
      ...
      <div>
        ...
        <div class='clearfix'/>
        <b:section class='FreeDemos-werd' id='top-NewsPro-main-widget-2' maxwidgets='1' name='Fresh Posts Section' showaddelement='no'>
          <b:widget id='HTML23' locked='false' title='World Fresh Updates' type='HTML' visible='true'>
            <b:widget-settings>
  ...
  <div id='center-container'>
    <div class='container outer-container'>
      ...
      <main id='feed-view'>
       <b:if cond='data:view.isHomepage'> 
    <!-- Featured Wrapper -->
      <b:section class='FreeDemos-werd' id='top-NewsPro-main-widget' maxwidgets='6' name='Main Featured Section' showaddelement='yes'>
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML42' locked='false' title='Editor Updates' type='HTML' visible='true'>
          <b:widget-settings>
        ...
        <b:section class='main' id='main' maxwidgets='1' name='Main Recent Posts' showaddelement='yes'>
          <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='authorLabel'>by cingster</b:widget-setting>
              <b:widget-setting name='showCommentLink'>true</b:widget-setting>
              <b:widget-setting name='style.urlcolor'>#5401d8</b:widget-setting>
              <b:widget-setting name='showAuthor'>true</b:widget-setting>
              <b:widget-setting name='style.linkcolor'>#f6f6f6</b:widget-setting>
            ...
            <b:includable id='main' var='this'>
              ...
              <div class='blog-posts hfeed container'>
                ...
                <b:if cond='data:view.isHomepage'>
                  <div class='main-title'><h3 class='title'><span><data:messages.recentPosts/></span></h3><a class='view-all' href='/search'><data:messages.showMore/></a></div>
                </b:if>
  ...
  <script>
   (adsbygoogle = window.adsbygoogle || []).push({});
            ...
            <b:includable id='headerByline' var='post'>
              <!-- Post Header Meta -->
                <div class='post-snip' itemprop='author' itemscope='itemscope' itemtype='https://schema.org/Person'>
                  <b:include data='post' name='postAuthorImage'/>
          ...
          <data:post.numberOfComments/></span></b:if>
         <b:if cond='data:view.isHomepage and data:post.allowComments'>
         <span class='comment-home-bubble'>
    ...
    <b:message name='messages.manageComments'/>
        ...
        noTitle: &quot;<data:messages.noTitle/>&quot;,
            ...
            <b:includable id='postAuthorImage' var='post'>
             <b:if cond='data:post.author.authorPhoto.image and data:view.isPost'>
         ...
         <article class='blog-post hentry' itemscope='itemscope' itemtype='https://schema.org/CreativeWork'>
            ...
            <b:includable id='postFeaturedImage' var='post'>
              ...
              <div class='post-filter-image' itemprop='image' itemscope='itemscope' itemtype='https://schema.org/ImageObject'>
                <a class='post-filter-link' expr:href='data:post.url'>
                  <b:if cond='data:post.featuredImage'> 
                  <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' expr:src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped, 680) : resizeImage(data:post.featuredImage, 680)' itemprop='url'/>
                    <b:else/>
                    <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' src='https://4.bp.blogspot.com/-O3EpVMWcoKw/WxY6-6I4--I/AAAAAAAAB2s/KzC0FqUQtkMdw7VzT6oOR_8vbZO6EJc-ACK4BGAYYCw/w680/nth.png'/>
                  </b:if><b:class expr:name='data:post.featuredImage.isYouTube ? &quot;video-nos&quot; : &quot;image-nos&quot;'/>
                </a>
            ...
            <b:includable id='postFooter' var='post'>
              ...
              <div class='post-footer'>
                ...
                <b:include cond='data:allBylineItems.backlinks' data='post' name='postRelated'/>
                 <b:include cond='data:allBylineItems.backlinks' data='post' name='postInnerAds'/>
              </div>
            </b:includable>
            ...
            <b:includable id='postJumpLink' var='post'><b:comment>Disabled</b:comment></b:includable>
                ...
                <li class='post-next'> 
                  <b:if cond='data:newerPageUrl'> 
                    <a class='next-post-link' expr:href='data:newerPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-newer-link&quot;' rel='next'>
                      <div class='FreeDemos-werr-inner'><span><data:messages.newer/></span><p/></div>
                    </a> 
                    <b:else/> 
                    <a rel='next'><div class='FreeDemos-werr-inner post-MenuNews-open'><span><data:messages.newer/></span><p><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></p></div></a> 
                  </b:if> 
                </li>
                <li class='post-prev'> 
                  <b:if cond='data:olderPageUrl'> 
                    <a class='prev-post-link' expr:href='data:olderPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-older-link&quot;' rel='previous'>
                      <div class='FreeDemos-werr-inner'><span><data:messages.older/></span><p/></div>
                    </a> 
                    <b:else/>
                    <a rel='previous'><div class='FreeDemos-werr-inner post-MenuNews-open'><span><data:messages.older/></span><p><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></p></div></a> 
                  </b:if> 
                </li>
              </ul>
            </b:includable>
  ...
  <div class='blog-pager container' id='blog-pager'>
    ...
    <b:include cond='data:view.url != data:blog.homepageUrl' name='homePageLink'/>
            ...
            <b:includable id='postTitle' var='post'>
              ...
              <b:if cond='data:view.isMultipleItems'>
                <h2 class='entry-title vcard' itemprop='mainEntityOfPage' itemtype='https://schema.org/mainEntityOfPage'>
                  <a expr:href='data:post.url' expr:title='data:post.title' rel='bookmark'><span itemprop='name'><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></span></a>
                </h2>
              </b:if>
              <b:if cond='data:view.isSingleItem'>
              <b:if cond='data:allBylineItems.labels'>
          ...
          <b:section cond='data:view.isPost' id='upper-ad' maxwidgets='1' name='Inside Post Ads' showaddelement='no'>
            <b:widget id='HTML8' locked='true' title='Top Post Ad' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;57a2d8f6c60692359d0d513400aa3933&#39;,
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:section cond='data:view.isPost' id='lower-ad' maxwidgets='1' name='Inside Post Ads' showaddelement='no'>
            <b:widget id='HTML9' locked='true' title='Below Post Ad' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;57a2d8f6c60692359d0d513400aa3933&#39;,
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:section class='main-ads-pikihome' id='main-ads-below' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
          <b:widget id='HTML21' locked='false' title='' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;57a2d8f6c60692359d0d513400aa3933&#39;,
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML7' locked='true' title='Hollywood Movies' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;fbafa3fb87e71d9f595f7ba99502028c&#39;,
		&#39;format&#39; : &#39;iframe&#39;,
		&#39;height&#39; : 50,
		&#39;width&#39; : 320,
		&#39;params&#39; : {}
	};
	document.write(&#39;&lt;scr&#39; + &#39;ipt type=&quot;text/javascript&quot; src=&quot;http&#39; + (location.protocol === &#39;https:&#39; ? &#39;s&#39; : &#39;&#39;) + &#39;://www.profitabledisplaynetwork.com/fbafa3fb87e71d9f595f7ba99502028c/invoke.js&quot;&gt;&lt;/scr&#39; + &#39;ipt&gt;&#39;);
&lt;/script&gt;</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <div class='clearfix'/>
            ...
            <b:if cond='data:view.isHomepage'>
      <b:section class='FreeDemos-werd' id='top-NewsPro-main-widget-1' maxwidgets='6' name='Main Feature Section' showaddelement='yes'>
        <b:widget id='HTML3' locked='false' title='' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'>&lt;script async=&quot;async&quot; data-cfasync=&quot;false&quot; src=&quot;//pl18807373.highrevenuegate.com/618dd76ad9878767b07b47156301c01d/invoke.js&quot;&gt;&lt;/script&gt;
&lt;div id=&quot;container-618dd76ad9878767b07b47156301c01d&quot;&gt;&lt;/div&gt;</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
      ...
      <div id='sidebar-container' itemscope='itemscope' itemtype='https://schema.org/WPSideBar' role='banner'>
        <b:section class='sidebar widget-control' id='sidebar1' name='Sidebar Right (A)' showaddelement='yes'>
          <b:widget id='HTML20' locked='false' title='' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;b28080a1381bf5ce62e81e1effb75839&#39;,
		&#39;format&#39; : &#39;iframe&#39;,
		&#39;height&#39; : 300,
		&#39;width&#39; : 160,
		&#39;params&#39; : {}
	};
	document.write(&#39;&lt;scr&#39; + &#39;ipt type=&quot;text/javascript&quot; src=&quot;http&#39; + (location.protocol === &#39;https:&#39; ? &#39;s&#39; : &#39;&#39;) + &#39;://www.profitabledisplaynetwork.com/b28080a1381bf5ce62e81e1effb75839/invoke.js&quot;&gt;&lt;/scr&#39; + &#39;ipt&gt;&#39;);
&lt;/script&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;b28080a1381bf5ce62e81e1effb75839&#39;,
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML19' locked='false' title='Banner 300x250' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;57a2d8f6c60692359d0d513400aa3933&#39;,
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML10' locked='false' title='Direct Link ad' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>https://www.highrevenuegate.com/mx8uxfacx?key=0c2faa2599577843cabb4230f8eb5eb0</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='PageList2' locked='false' title='Pages' type='PageList' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"8914542542065011666":{"href":"https://cingster.blogspot.com/p/about-us.html","position":0,"title":"About us"}}]]></b:widget-setting>
...
&lt;div id=&quot;container-618dd76ad9878767b07b47156301c01d&quot;&gt;&lt;/div&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML5' locked='false' title='Popunder ad' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<script type='text/javascript' src='//pl18807444.highrevenuegate.com/76/46/08/7646089f3cf39b3194db1a9bba87f86a.js'></script>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
  ...
  <b:include name='reportAbuse'/>
          ...
          <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"home":{"href":"http://cingster.blogspot.com/","position":0,"title":"Home"}}]]></b:widget-setting>
              <b:widget-setting name='homeTitle'>Home</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
        ...
        <b:section class='sidebar' id='social-widget' maxwidgets='1' name='Social Widget' showaddelement='yes'>
          <b:widget id='LinkList76' locked='true' title='Social Plugin' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-0'>http://fb.com/</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
        ...
        <b:section class='sidebar widget-control' id='sidebar' name='Sidebar Right (B)' showaddelement='yes'>
        ...
        <b:loop values='data:labels' var='label'>
          ...
          <b:widget id='HTML4' locked='false' title='' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;4344cd4a40e9855346c5cc8b1bd1f343&#39;,
		&#39;format&#39; : &#39;iframe&#39;,
		&#39;height&#39; : 600,
		&#39;width&#39; : 160,
		&#39;params&#39; : {}
	};
	document.write(&#39;&lt;scr&#39; + &#39;ipt type=&quot;text/javascript&quot; src=&quot;http&#39; + (location.protocol === &#39;https:&#39; ? &#39;s&#39; : &#39;&#39;) + &#39;://www.profitabledisplaynetwork.com/4344cd4a40e9855346c5cc8b1bd1f343/invoke.js&quot;&gt;&lt;/scr&#39; + &#39;ipt&gt;&#39;);
&lt;/script&gt;</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
 ...
 <div id='footer-ads'> 
  <div class='container outer-container'>
          <b:section class='FreeDemos-werd' id='top-NewsPro-main-widget-3' maxwidgets='1' name='Bottom Updates Section' showaddelement='no'>
            <b:widget id='HTML24' locked='false' title='Most Viewed' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'>4/sgrid/recent</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  ...
  <div class='widget-content'>
    ...
    <div class='clearfix'/>
  <b:section class='main-ads-pikihome' id='main-ads2' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
	...
	document.write(&#39;&lt;scr&#39; + &#39;ipt type=&quot;text/javascript&quot; src=&quot;http&#39; + (location.protocol === &#39;https:&#39; ? &#39;s&#39; : &#39;&#39;) + &#39;://www.profitabledisplaynetwork.com/57a2d8f6c60692359d0d513400aa3933/invoke.js&quot;&gt;&lt;/scr&#39; + &#39;ipt&gt;&#39;);&lt;/script&gt;</b:widget-setting>
      </b:widget-settings>
      <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
...
<div id='footer-wrapper' itemscope='itemscope' itemtype='https://schema.org/WPFooter' role='banner'> 
  <div class='container outer-container'>
    <div class='footer-widgets-wrap'>
      <b:section class='footer widget-control' id='footer-sec2' maxwidgets='3' name='Section (Left)' showaddelement='yes'>
        <b:widget id='HTML17' locked='false' title='Banner 160x300' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'>&lt;script type=&quot;text/javascript&quot;&gt;
	atOptions = {
		&#39;key&#39; : &#39;b28080a1381bf5ce62e81e1effb75839&#39;,
...
&lt;/script&gt;</b:widget-setting>
  ...
  <input class='search-action' expr:value='data:messages.search.escaped' type='submit'/>
      ...
      <b:section class='FreeDemos-werh footer widget-control' id='footer-widget' maxwidgets='3' name='Section (Center)' showaddelement='yes'>
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML13' locked='false' title='Latest posts' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'>4/footer/recent</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
      ...
      <b:section class='footer widget-control' id='footer-sec3' maxwidgets='3' name='Section (Right)' showaddelement='yes'>
        <b:widget id='PopularPosts2' locked='false' title='Trending topics' type='PopularPosts' visible='true'>
          <b:widget-settings>
      ...
      <b:section class='NewsFooter' id='NewsFooter' maxwidgets='2' name='Footer Info' showaddelement='yes'>
        <b:widget id='Image150' locked='true' title='About Us' type='Image' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEhiAsA6SaNX9eLNf78D4Jyo_jKF7GJY1hec5IQJHfjuP5PXV_ZkGvNWgZlSGJ9jEJvuL0DSdEmii5gmeMP_zmFPDaotdkp44meflmSptvhjMekB2sjkSJY2zlL5Nef4HE9oZwXEg8icMDT4zdX_AlQ2oG3DQ7bwv89uoAR9iwpBNXiH6l95o-24u_vXug=s294</b:widget-setting>
            <b:widget-setting name='displayHeight'>67</b:widget-setting>
            <b:widget-setting name='sectionWidth'>150</b:widget-setting>
            <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
            <b:widget-setting name='displayWidth'>294</b:widget-setting>
            <b:widget-setting name='link'>https://cingster.blogspot.com/</b:widget-setting>
            <b:widget-setting name='caption'>We offer real-time updates and the most recent news in the cinema entertainment industry. An DAGREG company.</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
        ...
        <b:widget id='LinkList7' locked='true' title='Follow Us' type='LinkList' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='link-3'>https://cingster.blogspot.com/</b:widget-setting>
            <b:widget-setting name='sorting'>NONE</b:widget-setting>
            <b:widget-setting name='link-4'>https://cingster.blogspot.com/</b:widget-setting>
            <b:widget-setting name='text-1'>twitter</b:widget-setting>
            <b:widget-setting name='link-1'>https://www.pikitemplates.com/</b:widget-setting>
            <b:widget-setting name='text-0'>facebook-f</b:widget-setting>
            <b:widget-setting name='link-2'>https://cingster.blogspot.com/</b:widget-setting>
            <b:widget-setting name='text-3'>instagram</b:widget-setting>
            <b:widget-setting name='link-0'>https://www.pikitemplates.com/</b:widget-setting>
            <b:widget-setting name='text-2'>youtube</b:widget-setting>
            <b:widget-setting name='text-4'>reddit</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
            <b:include name='content'/>
          </b:includable>
   ...
   <div id='footer-container'>
        <b:section class='footer-NBogger-menu' id='footer-NBogger-menu' maxwidgets='1' name='Footer Menu' showaddelement='yes'>
          <b:widget id='LinkList8' locked='true' title='Link List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-3'>https://cingster.blogspot.com/p/privacy-policy.html</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-4'>https://dagreg-company.blogspot.com/</b:widget-setting>
              <b:widget-setting name='text-1'>About us</b:widget-setting>
              <b:widget-setting name='link-1'>https://cingster.blogspot.com/p/about-us.html</b:widget-setting>
              <b:widget-setting name='text-0'>Home</b:widget-setting>
              <b:widget-setting name='link-2'>https://dagreg-company.blogspot.com/p/contact-us.html</b:widget-setting>
              <b:widget-setting name='text-3'>Privacy Policy</b:widget-setting>
              <b:widget-setting name='link-0'>https://cingster.blogspot.com/</b:widget-setting>
              <b:widget-setting name='text-2'>Contact us</b:widget-setting>
              <b:widget-setting name='text-4'>Parent company</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
      ...
      <b:section class='footer-copyright' id='footer-copyright' maxwidgets='1' name='Footer Attribution' showaddelement='no'>
        <b:widget id='HTML33' locked='true' title='Footer Copyright' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<span class='copyright-text widget'>Design by - <a href='https://www.pikitemplates.com/' id='pikitemplates' rel='dofollow'>Blogger Templates</a> | Distributed by <a href='https://www.bloggertemplate.org/' rel='dofollow'> BloggerTemplate.org</a></span>]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.4/jquery.min.js' type='text/javascript'/>
...
<div id='FreeDemos-were'>
  <div class='MenuNews-wrap'>
      <div class='FreeDemos-werw'/>
    <span class='hide-FreeDemos-weri'/>
  </div>
  <div class='FreeDemos-were-flex'>
    <div class='FreeDemos-weri' id='FreeDemos-weri'/>
